...
const { consultarUsuarios, consultarDocentes, consultarEstudiantes, accionesUsuarios, inactivacionUsuario } = require('../controllers/usuariosControllers');
...
router.get('/usuarios/:accion', estaAutenticado, consultarUsuarios, vistaUsuarios);
