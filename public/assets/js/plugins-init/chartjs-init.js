                        ...
                        datasets: [
                            {
                                data: [45, 25, 20, 10],
                                borderWidth: 0,
                                backgroundColor: ['rgba(0,161,91, .9)', 'rgba(0,161,91, .7)', 'rgba(255,167,215,1)', 'rgba(0,0,0,0.07)'],
                                hoverBackgroundColor: ['rgba(0,161,91, .9)', 'rgba(0,161,91, .7)', 'rgba(255,167,215,1)', 'rgba(0,0,0,0.07)'],
                            },
                        ],
                        ...
                        datasets: [
                            {
                                ...
                                backgroundColor: ['rgba(0,161,91)', 'rgba(98, 126, 234, 1)', 'rgba(238, 60, 60, 1)'],
                                hoverBackgroundColor: ['rgba(0,161,91, 0.9)', 'rgba(98, 126, 234, .9)', 'rgba(238, 60, 60, .9)'],
                            },
                        ],
                        // labels: [
                        //     "green",
                        ...
                        datasets: [
                            {
                                data: [15, 18, 9, 6, 19],
                                borderWidth: 0,
                                backgroundColor: ['rgba(0,161,91)', 'rgba(98, 126, 234, 1)', 'rgba(238, 60, 60, 1)', 'rgba(54, 147, 255, 1)', 'rgba(255, 92, 0, 1)'],
                            },
                        ],
                    },
                    options: {
